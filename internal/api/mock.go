...
func (m *MockClient) GetSystemInfo(ctx context.Context) (*model.SystemInfo, error) {
	if m.GetSystemInfoFn != nil { return m.GetSystemInfoFn(ctx) }
	return nil, nil
}
