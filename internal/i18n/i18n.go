...
var translations = map[string]map[string]string{
	...
	"up_to_date":      {"en": "already up to date", "fr": "deja a jour"},
	"updating":        {"en": "Updating", "fr": "Mise a jour de"},
	"updating_all":    {"en": "Updating all containers", "fr": "Mise a jour de tous les containers"},
