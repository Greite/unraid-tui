...
var translations = map[string]map[string]string{
	...
	"page_plugins":       {"en": "Plugins", "fr": "Plugins", "zh": "插件", "hi": "प्लगइन", "es": "Plugins", "ar": "إضافات"},
	"loading_plugins":    {"en": "Loading plugins...", "fr": "Chargement des plugins...", "zh": "加载插件中...", "hi": "प्लगइन लोड हो रहे हैं...", "es": "Cargando plugins...", "ar": "...جارٍ تحميل الإضافات"},
	"no_plugins":         {"en": "No plugins installed", "fr": "Aucun plugin installé", "zh": "未安装插件", "hi": "कोई प्लगइन नहीं", "es": "Sin plugins instalados", "ar": "لا توجد إضافات"},
	"plugins_installed":  {"en": "Installed Plugins", "fr": "Plugins installés", "zh": "已安装插件", "hi": "स्थापित प्लगइन", "es": "Plugins instalados", "ar": "الإضافات المثبتة"},
