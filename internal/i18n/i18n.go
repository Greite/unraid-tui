...
var translations = map[string]map[string]string{
	...
	"autostart":       {"en": "autostart", "fr": "demarrage auto", "zh": "自动启动", "hi": "ऑटोस्टार्ट", "es": "inicio auto", "ar": "تشغيل تلقائي"},
	"autostart_on":    {"en": "autostart ON", "fr": "demarrage auto ON", "zh": "自动启动 开", "hi": "ऑटोस्टार्ट चालू", "es": "inicio auto ON", "ar": "تشغيل تلقائي مفعل"},
	"autostart_off":   {"en": "autostart OFF", "fr": "demarrage auto OFF", "zh": "自动启动 关", "hi": "ऑटोस्टार्ट बंद", "es": "inicio auto OFF", "ar": "تشغيل تلقائي معطل"},
